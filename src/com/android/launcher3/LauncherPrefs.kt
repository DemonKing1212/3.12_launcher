...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        @JvmField val APP_DRAWER_CUSTOM_COLOR_DARK = backedUpItem("pref_app_drawer_custom_color_dark", 0xff000000.toInt())
        ...
        @JvmField val GRAYSCALE_ICON_MAP_LAWN = backedUpItem("pref_grayscale_icon_map_lawn", true)
        ...
        @JvmField val HOTSEAT_QSB_SPACE = backedUpItem("pref_hotseat_qsb_space", 22)
        ...
        @JvmField val OEM_STYLE_LAUNCH_ANIM = backedUpItem("pref_oem_style_launch_anim", false)
        @JvmField
        ...
        @JvmField val NAVBAR_BURN_IN_PROTECTION = backedUpItem("pref_navbar_burn_in_protection", false)
