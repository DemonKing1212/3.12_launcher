...
public class DeviceProfile {
    ...
    DeviceProfile(InvariantDeviceProfile inv, Info info,
        ...
        if (isQsbVisible && !isVerticalBarLayout() && !isQsbInline) {
            int prefQsbSpace = LauncherPrefs.HOTSEAT_QSB_SPACE.get(context);
            if (prefQsbSpace >= 0) {
                hotseatQsbSpace = pxFromDp(prefQsbSpace, mMetrics);
            }
        }
