...
public class LauncherIconProvider extends IconProvider {
    ...
    private Map<String, ThemeData> getThemedIconMap() {
        ...
        boolean useLawn = LauncherPrefs.GRAYSCALE_ICON_MAP_LAWN.get(mContext);
        int mapRes = useLawn ? R.xml.grayscale_icon_map_lawn : R.xml.grayscale_icon_map_stock;
        try (XmlResourceParser parser = res.getXml(mapRes)) {
