...
public class QuickstepTransitionManager implements OnDeviceProfileChangeListener {
    ...
    public static long getAppLaunchDuration(Context context) {
        if (context == null) {
            return 500;
        }
        return LauncherPrefs.get(context).get(LauncherPrefs.OEM_STYLE_LAUNCH_ANIM) ? 480 : 500;
    }
    ...
    private final boolean mIsOemStyle;

    private final long mAppLaunchDuration;
    private final long mAppLaunchAlphaDuration;
    private final int mAnimNavFadeOutDuration;
    private final int mClosingTransitionDurationMs;
    private final int mWidgetCrossfadeDurationMillis;
    private final long mAnimationDelayNavFadeIn;
    ...
    public QuickstepTransitionManager(QuickstepLauncher launcher) {
        ...
        mIsOemStyle = LauncherPrefs.get(mLauncher).get(LauncherPrefs.OEM_STYLE_LAUNCH_ANIM);
        mAppLaunchDuration = mIsOemStyle ? 480 : 500;
        mAppLaunchAlphaDuration = mIsOemStyle ? 125 : 50;
        mAnimNavFadeOutDuration = mIsOemStyle ? 160 : 133;
        mClosingTransitionDurationMs = mIsOemStyle ? 280 : 250;
        mWidgetCrossfadeDurationMillis = mIsOemStyle ? 180 : 125;
        mAnimationDelayNavFadeIn = mAppLaunchDuration - ANIMATION_NAV_FADE_IN_DURATION;
    ...
    private void startCrossDisplayMoveAnimation(TransitionInfo info, SurfaceControl.Transaction t,
        ...
        mHandler.post(() -> {
            new CrossDisplayMoveTransition(mLauncher, mAppLaunchDuration,
                    mClosingTransitionDurationMs)
    ...
    private Animator getOpeningWindowAnimators(View v,
        ...
        appAnimator.setDuration(mAppLaunchDuration);
        ...
        MultiValueUpdateListener listener = new MultiValueUpdateListener() {
            ...
            FloatProp mIconAlpha = new FloatProp(prop.iconAlphaStart, 0f,
                    clampToDuration(LINEAR, APP_LAUNCH_ALPHA_START_DELAY, mAppLaunchAlphaDuration,
                            mAppLaunchDuration));
            ...
            FloatProp mWindowRadius = new FloatProp(initialWindowRadius,
                    getWindowCornerRadius(mLauncher), mIsOemStyle ? cornerInterpolator : mOpeningInterpolator);
            ...
            FloatProp mNavFadeOut = new FloatProp(1f, 0f, clampToDuration(
                    NAV_FADE_OUT_INTERPOLATOR, mIsOemStyle ? 20 : 0, mAnimNavFadeOutDuration,
                    mAppLaunchDuration));
            FloatProp mNavFadeIn = new FloatProp(0f, 1f, clampToDuration(
                    NAV_FADE_IN_INTERPOLATOR, mAnimationDelayNavFadeIn,
                    ANIMATION_NAV_FADE_IN_DURATION, mAppLaunchDuration));
    ...
    private Animator getOpeningWindowAnimatorsForWidget(LauncherAppWidgetHostView v,
        ...
        appAnimator.addUpdateListener(new MultiValueUpdateListener() {
            ...
            final FloatProp mWidgetForegroundAlpha = new FloatProp(1, 0, clampToDuration(
                    mIsOemStyle ? DECELERATE_1_5 : LINEAR, 0, mWidgetCrossfadeDurationMillis / 2, mAppLaunchDuration));

            final FloatProp mWidgetFallbackBackgroundAlpha = new FloatProp(0, 1,
                    clampToDuration(LINEAR, 0, 75, mAppLaunchDuration));
            final FloatProp mPreviewAlpha = new FloatProp(0, 1, clampToDuration(
                    LINEAR,
                    mWidgetCrossfadeDurationMillis / 2 /* delay */,
                    mWidgetCrossfadeDurationMillis / 2 /* duration */,
                    mAppLaunchDuration));
            final Interpolator cornerInterpolator = new PathInterpolator(0.2f, 0f, 0.2f, 1f);
            final FloatProp mWindowRadius = new FloatProp(initialWindowRadius, finalWindowRadius,
                    mIsOemStyle ? cornerInterpolator : mOpeningInterpolator);
            ...
            final FloatProp mNavFadeOut = new FloatProp(1f, 0f, clampToDuration(
                    NAV_FADE_OUT_INTERPOLATOR, 0, mAnimNavFadeOutDuration,
                    mAppLaunchDuration));
    ...
    private Animator getBackgroundAnimator() {
        ...
        ObjectAnimator backgroundRadiusAnim = ObjectAnimator.ofFloat(
                ...
                .setDuration(mAppLaunchDuration);
    ...
    private void addRemoteAnimations(RemoteAnimationDefinition definition) {
        ...
        definition.addRemoteAnimation(WindowManager.TRANSIT_OLD_WALLPAPER_OPEN,
                ...
                new RemoteAnimationAdapter(
                        ...
                        mClosingTransitionDurationMs, 0 /* statusBarTransitionDelay */));
    }
    ...
    private Animator getFallbackClosingWindowAnimators(RemoteAnimationTarget[] appTargets) {
        ...
        int duration = mClosingTransitionDurationMs;
        ...
        float translateY = isFreeform
            ? mClosingFreeformWindowTransY
            : (mIsOemStyle ? mClosingWindowTransY * 1.0f : mClosingWindowTransY);
        float endScale = isFreeform ? 0.95f : (mIsOemStyle ? 0.97f : 1f);
    ...
    private static class RemoteAnimationCoordinateTransfer {
        ...
        void transferRectToTargetCoordinate(RemoteAnimationTarget target, RectF currentRect,
            ...
            final boolean isOemStyle = LauncherPrefs.get(mLauncher).get(LauncherPrefs.OEM_STYLE_LAUNCH_ANIM);
            final int heightPx = isOemStyle
    ...
    private class SpringAnimRunner implements RectFSpringAnim.OnUpdateListener {
        ...
        public float getCornerRadius(float progress) {
            float curvedProgress = mIsOemStyle ? CORNER_LEAD_INTERPOLATOR.getInterpolation(progress) : progress;
